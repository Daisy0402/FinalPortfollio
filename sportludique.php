  ...
  <div class="hero hero-single route bg-image" style="background-image: url(assets/img/overlay-bg.jpg)">
    ...
    <div class="hero-content display-table">
      <div class="table-cell">
        <div class="container">
          <h2 class="hero-title mb-4">SportLudique</h2>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="portfolio-details-slider swiper">
              <div class="swiper-wrapper align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="assets/img/spotludique_acceuil.png" alt="">
                </div>

                <div class="swiper-slide">
                  <img src="assets/img/spo_admin.PNG" alt="">
                </div>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="copyright-box">
            <p class="copyright">&copy; Copyright <strong>Daisy Tacita</strong>. Tout droit réservés</p>
            <div class="credits">
              <!--
